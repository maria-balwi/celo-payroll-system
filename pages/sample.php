                                    ...
                                    <div class="col-12">
                                        <select class="form-select" id="payrollCycleID" name="payrollCycleID">
                                            ...
                                            <?php
                                                ...
                                                $extendedTo = '2026-02-26';

                                                function calculateSegmentHours ($payrollCycleFrom, $payrolCycleTo, $attendanceDate, $empID, &$totalRegularNightHours, &$totalRegularHolidayHours, &$totalRegularHolidayNDHours, &$totalSpecialHolidayHours, &$totalSpecialHolidayNDHours, &$incompleteAttendance) {
                                                ...
                                                $attendanceQuery = mysqli_query($conn, "SELECT * FROM tbl_attendance WHERE empID = 14 AND logTypeID (1,2,3,4) AND attendanceDate BETWEEN '$payrollCycleFrom' AND '$extendedTo' ORDER BY attendanceDate ASC, attendanceTime ASC");
