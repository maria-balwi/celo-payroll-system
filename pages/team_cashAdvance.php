...
<html lang="en">
    ...
    <body>
                            ...
                            <?php
                                ...
                                if ($_SESSION['departmentID'] == 1) {
                                    ...
                                    if ($_SESSION['designationID'] == 5) { 
                                        $cashAdvanceQuery = mysqli_query($conn, $employees->viewCashAdvanceApplicationsOperationsManager());
                                    ...
                                    // IT VIEW
                                    $cashAdvanceQuery = mysqli_query($conn, $employees->viewCashAdvanceApplicationsIT());
                                    while ($cashAdvanceDetails = mysqli_fetch_array($cashAdvanceQuery)) {
        ...
        <script src="../assets/js/team_cashAdvance.js?v=<?php echo $version; ?>"></script>
