...
<html lang="en">
    ...
    <body>
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200">
                                                    <?php
                                                        ...
                                                        if ($_SESSION['departmentID'] == 1) 
                                                        {
                                                            ...
                                                            {
                                                                $disputeAttendance = mysqli_query($conn, $payroll->pendingDisputesAttendanceOpsManager());
                                                        ...
                                                        {
                                                            $disputeAttendance = mysqli_query($conn, $payroll->pendingDisputesAttendanceIT());
                                                            while ($disputeDetails = mysqli_fetch_array($disputeAttendance)) {
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200">
                                                    <?php
                                                        if ($_SESSION['departmentID'] == 1) 
                                                        {
                                                            if ($_SESSION['designationID'] == 5)
                                                            {
                                                                $disputeAttendance = mysqli_query($conn, $payroll->approvedDisputesAttendanceOpsManager());
                                                                while ($disputeDetails = mysqli_fetch_array($disputeAttendance)) {
                                                            ...
                                                            {
                                                                $disputeAttendance = mysqli_query($conn, $payroll->approvedDisputesAttendanceOpsTL());
                                                                while ($disputeDetails = mysqli_fetch_array($disputeAttendance)) {
                                                        ...
                                                        {
                                                            $disputeAttendance = mysqli_query($conn, $payroll->approvedDisputesAttendanceIT());
                                                            while ($disputeDetails = mysqli_fetch_array($disputeAttendance)) {
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200">
                                                    <?php
                                                        if ($_SESSION['departmentID'] == 1) 
                                                        {
                                                            if ($_SESSION['designationID'] == 5)
                                                            {
                                                                $disputeAttendance = mysqli_query($conn, $payroll->disapprovedDisputesAttendanceOpsManager());
                                                                while ($disputeDetails = mysqli_fetch_array($disputeAttendance)) {
                                                            ...
                                                            {
                                                                $disputeAttendance = mysqli_query($conn, $payroll->disapprovedDisputesAttendanceOpsTL());
                                                                while ($disputeDetails = mysqli_fetch_array($disputeAttendance)) {
                                                        ...
                                                        {
                                                            $disputeAttendance = mysqli_query($conn, $payroll->disapprovedDisputesAttendanceIT());
                                                            while ($disputeDetails = mysqli_fetch_array($disputeAttendance)) {
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200">
                                                    <?php
                                                        if ($_SESSION['departmentID'] == 1) 
                                                        {
                                                            if ($_SESSION['designationID'] == 5)
                                                            {
                                                                $disputeLeaves = mysqli_query($conn, $payroll->pendingDisputesLeavesOpsManager());
                                                            ...
                                                            {
                                                                $disputeLeaves = mysqli_query($conn, $payroll->pendingDisputesLeavesOpsTL());
                                                                while ($disputeDetails = mysqli_fetch_array($disputeLeaves)) {
                                                        ...
                                                        {
                                                            $disputeLeaves = mysqli_query($conn, $payroll->pendingDisputesLeavesIT());
                                                            while ($disputeDetails = mysqli_fetch_array($disputeLeaves)) {
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200">
                                                    <?php
                                                        if ($_SESSION['departmentID'] == 1) 
                                                        {
                                                            if ($_SESSION['designationID'] == 5)
                                                            {
                                                                $disputeLeaves = mysqli_query($conn, $payroll->approvedDisputesLeavesOpsManager());
                                                                while ($disputeDetails = mysqli_fetch_array($disputeLeaves)) {
                                                            ...
                                                            {
                                                                $disputeLeaves = mysqli_query($conn, $payroll->approvedDisputesLeavesOpsTL());
                                                                while ($disputeDetails = mysqli_fetch_array($disputeLeaves)) {
                                                        ...
                                                        {
                                                            $disputeLeaves = mysqli_query($conn, $payroll->approvedDisputesLeavesIT());
                                                            while ($disputeDetails = mysqli_fetch_array($disputeLeaves)) {
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200">
                                                    <?php
                                                        if ($_SESSION['departmentID'] == 1) 
                                                        {
                                                            if ($_SESSION['designationID'] == 5)
                                                            {
                                                                $disputeLeaves = mysqli_query($conn, $payroll->disapprovedDisputesLeavesOpsManager());
                                                                while ($disputeDetails = mysqli_fetch_array($disputeLeaves)) {
                                                            ...
                                                            {
                                                                $disputeLeaves = mysqli_query($conn, $payroll->disapprovedDisputesLeavesOpsTL());
                                                                while ($disputeDetails = mysqli_fetch_array($disputeLeaves)) {
                                                        ...
                                                        {
                                                            $disputeLeaves = mysqli_query($conn, $payroll->disapprovedDisputesLeavesIT());
                                                            while ($disputeDetails = mysqli_fetch_array($disputeLeaves)) {
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200">
                                                    <?php
                                                        if ($_SESSION['departmentID'] == 1) 
                                                        {
                                                            if ($_SESSION['designationID'] == 5)
                                                            {
                                                                $disputeOvertime = mysqli_query($conn, $payroll->pendingDisputesOvertimeOpsManager());
                                                            ...
                                                            {
                                                                $disputeOvertime = mysqli_query($conn, $payroll->pendingDisputesOvertimeOpsTL());
                                                                while ($disputeDetails = mysqli_fetch_array($disputeOvertime)) {
                                                        ...
                                                        {
                                                            $disputeOvertime = mysqli_query($conn, $payroll->pendingDisputesOvertimeIT());
                                                            while ($disputeDetails = mysqli_fetch_array($disputeOvertime)) {
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200">
                                                    <?php
                                                        if ($_SESSION['departmentID'] == 1) 
                                                        {
                                                            if ($_SESSION['designationID'] == 5)
                                                            {
                                                                $disputeOvertime = mysqli_query($conn, $payroll->approvedDisputesOvertimeOpsManager());
                                                                while ($disputeDetails = mysqli_fetch_array($disputeOvertime)) {
                                                            ...
                                                            {
                                                                $disputeOvertime = mysqli_query($conn, $payroll->approvedDisputesOvertimeOpsTL());
                                                                while ($disputeDetails = mysqli_fetch_array($disputeOvertime)) {
                                                        ...
                                                        {
                                                            $disputeOvertime = mysqli_query($conn, $payroll->approvedDisputesOvertimeIT());
                                                            while ($disputeDetails = mysqli_fetch_array($disputeOvertime)) {
                                                ...
                                                <tbody class="bg-white divide-y divide-gray-200">
                                                    <?php
                                                        if ($_SESSION['departmentID'] == 1) 
                                                        {
                                                            if ($_SESSION['designationID'] == 5)
                                                            {
                                                                $disputeOvertime = mysqli_query($conn, $payroll->disapprovedDisputesOvertimeOpsManager());
                                                                while ($disputeDetails = mysqli_fetch_array($disputeOvertime)) {
                                                            ...
                                                            {
                                                                $disputeOvertime = mysqli_query($conn, $payroll->disapprovedDisputesOvertimeOpsTL());
                                                                while ($disputeDetails = mysqli_fetch_array($disputeOvertime)) {
                                                        ...
                                                        {
                                                            $disputeOvertime = mysqli_query($conn, $payroll->disapprovedDisputesOvertimeIT());
                                                            while ($disputeDetails = mysqli_fetch_array($disputeOvertime)) {
        ...
        <script src="../assets/js/team_disputes.js?v=<?php echo $version; ?>"></script>
