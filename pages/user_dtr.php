                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <?php 
                                    ...
                                    while ($dtrDetails = mysqli_fetch_array($dtrQuery)) {
                                        ...
                                        echo "<td class=' whitespace-nowrap'>" . $dtr_attendanceDate . "</td>";
                                        echo "<td class=' whitespace-nowrap'>" . $dtr_time . "</td>";
                                        echo "<td class=' whitespace-nowrap'>" . $dtr_attendanceTime . "</td>";
                                        echo "<td class=' whitespace-nowrap'>" . $dtr_logType . "</td>";
                                        echo "</tr>";
                                    }
                                ?>
                            </tbody>
