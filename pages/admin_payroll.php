                ...
                <div class="mx-auto my-3 py-2 overflow-auto">
                    <table id="payrollTable" class="table table-striped table-bordered table-auto text-center pt-3">
                        <thead class="bg-gray-50">
                            <tr>
                                <th class="px-6 py-3 text-xs font-medium text-gray-500 uppercase tracking-wider align-middle whitespace-nowrap">Reference No.</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <?php
                                ...
                                while ($payrollDetails = mysqli_fetch_array($payrollQuery)) {
                                    ...
                                    $payrollReferenceNo = $payrollDetails['referenceNum'];
                                    ...
                                    echo "<tr>";
                                    echo "<td class ='whitespace-nowrap'>" . $payrollReferenceNo. "</td>";
                                    echo "<td class ='whitespace-nowrap'>" . $payrollDateFrom . date('-Y'). "</td>";
                                    echo "<td class ='whitespace-nowrap'>" . $payrollDateTo . date('-Y') . "</td>";
