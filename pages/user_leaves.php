            ...
            <main class="flex-1 p-3 overflow-auto">
                <div class="flex flex-1 p-2 text-2xl font-bold justify-between items-center">
                    ...
                    <div class="relative inline-block text-right">
                        ...
                        <a href="user_leaveForm.php" class="inline-flex justify-center w-full rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-blue-500 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none">File a Leave</a>
                    </div>
                </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php
                                    ...
                                    while ($leaveDetails = mysqli_fetch_array($leaveQuery)) {
                                        ...
                                        echo "<td ='px-6 py-4 whitespace-nowrap'>" . $leave_dateFiled . "</td>";
                                        echo "<td ='px-6 py-4 whitespace-nowrap'>" . $leave_leaveType . "</td>";
                                        echo "<td ='px-6 py-4 whitespace-nowrap'>" . $leave_days . "</td>";
                                        echo "<td ='px-6 py-4 whitespace-nowrap'>" . $leave_effectivityDate . "</td>";
                                        echo "<td ='px-6 py-4 whitespace-nowrap'>" . $leave_remarks . "</td>";
