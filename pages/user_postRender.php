                    ...
                    <table id="example" class="table table-bordered table-striped min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="text-xs font-medium text-gray-500 uppercase tracking-wider">Sub Leave Type</th>
                                <th class="text-xs font-medium text-gray-500 uppercase tracking-wider">Days</th>
                                <th class="text-xs font-medium text-gray-500 uppercase tracking-wider">Inclusive Dates</th>
                                <th class="text-xs font-medium text-gray-500 uppercase tracking-wider">Purpose | Remarks</th>
                                <th class="text-xs font-medium text-gray-500 uppercase tracking-wider">Attachments</th>
                                <th class="text-xs font-medium text-gray-500 uppercase tracking-wider">Paid</th>
