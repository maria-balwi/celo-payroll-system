                    ...
                    <div class="modal-dialog modal-none modal-sm modal-dialog-centered">
                        <div class="modal-content" id="fileRequestModal">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="userFormLabel">File Change Shift Request</h1>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row g-3 mb-2">
                                    <div class="col-12">
                                        <label for="purpose">Reason / Remarks:</label>
                                    </div>
                                </div>

                                <div class="row g-3 mb-2">
                                    <div class="col-12">
                                        <textarea type="text" id="purpose" name="purpose" placeholder="Reason / Remarks" rows="3" class="form-control" required></textarea>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-content" id="viewRequestModal">
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <div class="row g-2 mb-2 inclusiveDatesRow">
                                    <div class="col-3">
