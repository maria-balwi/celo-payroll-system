...
<?php
    ...
    // //DATABASE CONFIGURATIONS
    // $host = "localhost";
    // $username = "celobusi_payroll_user";
    // $password = "C3l0p@ssw0rd@65";
    // $database = "celobusi_payroll";

    // // API Keys
    // define(constant_name: 'SENTRY_BASE_URL', 'https://nonfimbriated-norris-first.ngrok-free.dev/api/Integration');
    // define('SENTRY_API_USERNAME', '1010');
    // define('SENTRY_API_PASSWORD', 'C3l0p@ssw0rd@65');
