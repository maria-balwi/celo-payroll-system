    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if ($_POST['action'] == "generate") {
            ...
            if (mysqli_num_rows($payrollIDQuery) == 0) {
                ...
                $payslip_otherAllowances = $payslipDetails['payslip_otherAllowances'] == 0 ? "-" : number_format($payslipDetails['payslip_otherAllowances'], 2);
                ...
                $payslip_lateMins = $payslipDetails['totalLateMins'] == 0 ? "-" : number_format($payslipDetails['totalLateMins'], 0);
                $payslip_lateMinsAmt = $payslipDetails['payslip_lateMins'] == 0 ? "-" : number_format($payslipDetails['payslip_lateMins'], 2);
                $payslip_undertimeMins = $payslipDetails['totalUndertimeMins'] == 0 ? "-" : number_format($payslipDetails['totalUndertimeMins'], 0);
                $payslip_undertimeMinsAmt = $payslipDetails['payslip_undertimeMins'] == 0 ? "-" : number_format($payslipDetails['payslip_undertimeMins'], 2);
                ...
                $isRegularOT = 0;
                $isRestOT = 0;
                while ($overtimeDetails = mysqli_fetch_array($overtimeQuery)) {
                    if ($overtimeDetails['otType'] == "Regular") {
                        $isRegularOT = 1;
                    }
                    else if ($overtimeDetails['otType'] == "Rest Day") {
                        $isRestOT = 1;
                    }
                }
                $isOvertime = $isRegularOT && $isRestOT ? 1 : 0;

                $payslip = '';
                if ($isHoliday == 1 && $isOvertime == 1) {
                    $payslip = '
                        <div>
                            <div class="text-center font-bold text-xl bg-green-300 py-2">For the Period of '.$date.'
                                
                            </div>
                            <div class="text-center font-bold text-lg">CELO BUSINESS SOLUTIONS, INCasdasdasd.</div>
                ...
                else if ($isHoliday == 1 && $isRegularOT == 1) {
                    $payslip = '
                        <div>
                            <div class="text-center font-bold text-xl bg-green-300 py-2">For the Period of '.$date.'
                ...
                else if ($isSpecial == 1 && $isRegularOT == 1) {
                    $payslip = '
                        <div>
                            <div class="text-center font-bold text-xl bg-green-300 py-2">For the Period of '.$date.'
                ...
                else if ($isSpecial == 1 && $isRestOT == 1) {
                    $payslip = '
                        <div>
                            <div class="text-center font-bold text-xl bg-green-300 py-2">For the Period of '.$date.'
                ...
                else if ($isLegal == 1 && $isRegularOT == 1) {
                    $payslip = '
                        <div>
                            <div class="text-center font-bold text-xl bg-green-300 py-2">For the Period of '.$date.'
