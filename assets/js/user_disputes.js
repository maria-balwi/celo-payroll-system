...
$(document).ready(function() {
        ...
        if (dataType == '') {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "../backend/user/fileDispute.php",
                        data: fileDispute,
                        contentType: false,
                        processData: false,
    ...
    $(document).on('click', '.attendanceView', function() {
        ...
        $.ajax({
            type: "GET",
            url: "../backend/user/disputeModal.php?dispute_id=" + id_dispute,
        ...
        //     $.ajax({
        //         type: "GET",
        //         url: "../backend/user/adjustmentModal.php?allowance_id=" + id_allowance,
        //         success: function(response) {
        ...
        //                         $.ajax({
        //                             url: "../backend/user/deleteAdjustment.php",
        //                             type: 'POST',
        //                             data: {
    ...
    //                 $.ajax({
    //                     url: '../backend/user/updateAdjustment.php',
    //                     type: 'POST',
    //                     data: $(this).serialize(),
    //                     cache: false,
    //                     success: function(res) {
